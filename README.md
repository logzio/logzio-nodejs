...
**Note:** If logzio-js is used as part of a serverless service (AWS Lambda, Azure Functions, Google Cloud Functions), add `logger.sendAndClose()` at the end of the run.
